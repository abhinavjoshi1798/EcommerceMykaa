...
const FootArr = [
  ...
  {
    head: "Inspire Me",
    arr: ["Beauty Book", "Mykaa TV", "Mykaa Network", "Buying Guides"],
  },
  {
    head: "Quick Links",
    arr: [
...
const Footer = () => {
  ...
  const emailDiv = (
    <SimpleGrid gap={"8px"} padding="30px">
      <Heading as="h2" size="14px" display={"flex"} alignItems={"center"}>
        <EmailIcon m={2} /> Get special discount on your inbox
      </Heading>
      <SimpleGrid gap="8px" display={"flex"} justifyContent={"space-around"}>
        <Input
          border="0px"
  ...
  return (
    <SimpleGrid color="white" marginBottom={"0px"}>
      <SimpleGrid
        bg="#3f414d"
        style={{
          display: "flex",
        ...
        <SimpleGrid gap={"8px"} display="flex">
          ...
          <SimpleGrid gap="8px">
            <Heading as="h2" size="14px">
              {" "}
              Experience The Mykaa Mobile App
            </Heading>
            <Image
              m="auto"
              borderRadius={"10px"}
      ...
      <SimpleGrid bg="#fc2779" padding="30px">
        {screen === "lg" ? (
          ...
          <Heading textAlign={"center"} as="h2" size="12px">
            HELP CENTER
          </Heading>
        )}
        <Text margin={"auto"} fontSize="md">
