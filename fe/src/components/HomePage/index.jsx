...
import TwoCard from "./Components/TowCardPerRow";
...
import { afterOnlyatNaykaa } from "./Data/afterOnlyatNaykaa";
import { FeaturedBrands, afterFeatureBrand } from "./Data/FeaturedBrand";
import { BeautyAdvice } from "./Data/BeautiAdvice";
...
const HomePage = () => {
  return (
    <>
      ...
      <MainHeading>Only At Mykaa</MainHeading>
